...
import android.util.AttributeSet;
    ...
    public class CampoTEL extends AppCompatEditText {
        ...
        public CampoTEL(Context context, AttributeSet attrs, int defStyle) {
            super(context, attrs, defStyle);
            initialize();

        }

        public CampoTEL(Context context, AttributeSet attrs) {
            super(context, attrs);
            initialize();

        }

        public CampoTEL(Context context) {
            super(context);
            initialize();
        ...
        public String getCleanText() {
            String text = CampoTEL.this.getText().toString();
            ...
            this.addTextChangedListener(new TextWatcher() {
				...
				/* Strip any non numeric digit from the String... */
                    ...
                    if(length==11) {
                       ...
                       part2 = paddedNumber.substring(7).trim();
                       ...
                       ddd = paddedNumber.substring(0, 2);
                        ...
                        part2 = paddedNumber.substring(6).trim();
				 ...
				 */
                    isUpdating = true;
                    CampoTEL.this.setText(phone);

                    CampoTEL.this.setSelection(positioning[length]);
