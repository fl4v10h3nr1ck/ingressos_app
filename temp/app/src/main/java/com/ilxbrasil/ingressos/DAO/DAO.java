package com.ilxbrasil.ingressos.DAO;
...
public class DAO<T> extends SQLiteOpenHelper{
	...
	private static final String BD_NOME = "astal";

    public static final String TAB_PREFIXO = "stl_";
	...
	private static final String[] BD_ESQUEMA ={
			...
			"CREATE TABLE IF NOT EXISTS "+TAB_PREFIXO+"ip_servidor (" +
					"id integer primary key autoincrement, " +
					"ip text null);",


			"CREATE TABLE IF NOT EXISTS "+TAB_PREFIXO+"usuario (" +
					"id integer primary key autoincrement, " +
					"id_remoto integer null, " +
					"nome text null);"};
